      ...
      <div className="w-full max-w-sm space-y-8 rounded-xl bg-[#1A1D21] p-8 shadow-xl border border-gray-800">
        ...
        <div className="mt-8">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded bg-white px-4 py-3 text-xs font-black text-black hover:bg-gray-200 transition-colors uppercase tracking-widest"
          >
